...
<head>
    ...
    <title>Exemple de l'UserManager::selectOneUser()</title>
...
<body>
    ...
    <div class="mt-8 px-12 flex justify-center">
        <div class="max-w-4xl bg-white rounded-lg  p-6 mb-7">
            <h2 class="text-2xl font-bold text-gray-800 mb-4 text-center">Détails de l'utilisateur</h2>
