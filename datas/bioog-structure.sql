...
CREATE TABLE IF NOT EXISTS `bioog`.`article` (
  ...
  `user_user_id` INT UNSIGNED NULL,
...
CREATE TABLE IF NOT EXISTS `bioog`.`comment_has_article` (
  `comment_comment_id` INT UNSIGNED NULL,
  `article_article_id` INT UNSIGNED NULL,
...
CREATE UNIQUE INDEX `article_article_id_UNIQUE` ON `bioog`.`comment_has_article` (`article_article_id` ASC) VISIBLE;

CREATE UNIQUE INDEX `comment_comment_id_UNIQUE` ON `bioog`.`comment_has_article` (`comment_comment_id` ASC) VISIBLE;
...
CREATE UNIQUE INDEX `comment_comment_id_UNIQUE` ON `bioog`.`comment_has_user` (`comment_comment_id` ASC) VISIBLE;

CREATE UNIQUE INDEX `user_user_id_UNIQUE` ON `bioog`.`comment_has_user` (`user_user_id` ASC) VISIBLE;
...
CREATE UNIQUE INDEX `article_article_id_UNIQUE` ON `bioog`.`tag_has_article` (`article_article_id` ASC) VISIBLE;

CREATE UNIQUE INDEX `tag_tag_id_UNIQUE` ON `bioog`.`tag_has_article` (`tag_tag_id` ASC) VISIBLE;
